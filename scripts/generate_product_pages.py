...
PRODUCTS = [
    {
        ...
        "sidebar_title": "Explore the Full ERP Brochure",
        "sidebar_text": "Browse every AIBizs ERP module — finance, supply chain, CRM, manufacturing, projects, and more — in one shareable brochure.",
        "sidebar_cta": "View Brochure",
        "sidebar_cta_href": "erp-brochure.html",
        ...
        "modules": [
            ("bi-cash-stack", "Finance", "Comprehensive financial management and accounting operations", "erp-finance.html"),
            ("bi-arrow-down-circle", "Accounts Payable", "Manage vendor invoices, payments, and outstanding liabilities", "erp-accounts-payable.html"),
            ("bi-arrow-up-circle", "Accounts Receivable", "Track customer invoices, payments, and receivables management", "erp-accounts-receivable.html"),
            ("bi-journal-text", "General Ledger", "Central accounting ledger with complete financial transaction records", "erp-general-ledger.html"),
            ("bi-bank", "Treasury", "Cash management, banking operations, and financial planning", "erp-treasury.html"),
            ("bi-box-seam", "Inventory Management", "Real-time inventory tracking, stock control, and warehouse management", "erp-inventory-management.html"),
            ("bi-gear", "Operation Management", "Streamline day-to-day business operations and workflows", "erp-operation-management.html"),
            ("bi-person-heart", "Customer Relationship Management", "Manage customer interactions, sales pipeline, and customer service", "erp-crm.html"),
            ("bi-truck", "Supplier Relation Management", "Manage supplier relationships, contracts, and procurement processes", "erp-srm.html"),
            ("bi-door-open", "Vendor Portal", "Self-service portal for vendors to manage orders and invoices", "erp-vendor-portal.html"),
            ("bi-receipt", "E-Invoicing", "Electronic invoice generation, submission, and compliance management", "erp-e-invoicing.html"),
            ("bi-people-fill", "Human Resource Management", "Complete HR operations including employee data and HR processes", "erp-human-resource-management.html"),
            ("bi-cpu", "Manufacturing", "Production planning, bill of materials, and manufacturing execution", "erp-manufacturing.html"),
            ("bi-kanban", "Project Management", "Plan, track, and manage projects with resources and timelines", "erp-project-management.html"),
            ("bi-person-badge", "Employee Self Service", "Employee portal for accessing personal information and services", "erp-employee-self-service.html"),
        ],
        "platform": [
    ...
    },
    {
        ...
        "sidebar_title": "Explore the Full QHSE Brochure",
        "sidebar_text": "Browse every AIBizs QHSE module — risk, incidents, inspections, journey management, MOC, quality, and more — in one shareable brochure.",
        "sidebar_cta": "View Brochure",
        "sidebar_cta_href": "qhse-brochure.html",
        ...
        "modules": [
            ("bi-exclamation-triangle", "Risk Identification & Loss Reporting", "Identify potential risks, assess impact, and track loss incidents systematically", "qhse-risk-identification.html"),
            ("bi-clipboard-x", "Incident Management", "Report, track, and manage workplace incidents and near-misses effectively", "qhse-incident-management.html"),
            ("bi-search", "Inspection", "Schedule, conduct, and document safety and quality inspections", "qhse-inspection.html"),
            ("bi-geo-alt", "Journey Plan with IVMS Integration", "Plan and monitor vehicle journeys with integrated vehicle tracking", "qhse-journey-plan.html"),
            ("bi-arrow-repeat", "Management of Change", "Control and manage organizational changes with risk assessment", "qhse-management-of-change.html"),
            ("bi-award", "Quality Management", "Ensure quality standards through quality control and assurance processes", "qhse-quality-management.html"),
            ("bi-star", "Vendor Evaluation", "Assess and evaluate vendor performance and compliance standards", "qhse-vendor-evaluation.html"),
            ("bi-calendar-event", "Meeting", "Schedule and manage safety meetings, agendas, and action items", "qhse-meeting.html"),
            ("bi-check-circle", "Fit to Work", "Assess employee fitness for work and manage medical clearances", "qhse-fit-to-work.html"),
            ("bi-folder2-open", "Document Management", "Control HSE documents, policies, procedures, and versioned controlled records", "qhse-document-management.html"),
        ],
        "platform": [
            ("bi-robot", "AI Integration", "All modules come with AI integration capabilities"),
