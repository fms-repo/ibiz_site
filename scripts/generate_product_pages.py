...
PRODUCTS = [
    ...
    },
    {
        ...
        "lead": "AIBizs HRMS centralizes people operations with payroll automation, leave management, recruitment pipelines, appraisals, and employee self-service — tailored for Omani organizations.",
    ...
    },
    {
        ...
        "subtitle": "AWS Architecture & Data Flow",
        "icon": "bi-cloud",
        "meta": "Enterprise Platform",
        "description": "Enterprise-grade cloud architecture on AWS with CI/CD pipelines, robust backup strategies, monitoring, and incident management with SLA commitments.",
        "lead": "AIBizs designs and operates secure AWS cloud environments with automated deployments, daily backups, VPN-secured production access, and 24/7 monitoring.",
        "overview_title": "Secure, Scalable Cloud Operations",
        "overview_p1": "Our cloud infrastructure practice covers architecture design, CI/CD automation, backup and disaster recovery, and production isolation. Releases flow through pipelines with zero-touch deployment — no manual changes on production systems.",
        "overview_p2": "Monitoring covers URL availability, resource consumption, and server performance, backed by incident management processes with defined SLAs and stakeholder communication.",
        "image": "presentation/clouud_intr_imag.png",
        "image_alt": "AWS cloud infrastructure architecture",
        "sidebar_title": "Plan Your Cloud Journey",
        "sidebar_text": "Discuss AWS architecture, CI/CD setup, and managed operations with our infrastructure team.",
        "sidebar_cta": "Request Consultation",
        "sidebar_cta_href": "index.html#contact",
        "sidebar_guarantee": "SLA-Backed Operations",
        "sidebar_items": [
            ("bi-cloud", "AWS Architecture", "Scalable cloud design and deployment"),
            ("bi-arrow-repeat", "CI/CD Pipelines", "Automated zero-touch releases"),
            ("bi-shield-check", "Security & Backup", "VPN access and daily backups"),
        ],
        "modules": [
            ("bi-hdd-stack", "Daily VM & Database Backups", "Daily protection of all virtual machines and database backups every 12 hours, stored in S3"),
            ("bi-shield-lock", "Restricted Production Access", "Production isolated so only authorized personnel can access systems"),
            ("bi-git", "Zero-Touch CI/CD Deployment", "Releases go through CI/CD pipelines with no manual production changes"),
            ("bi-lock", "VPN-Secured Connection", "Encrypted VPN required for all production access sessions"),
            ("bi-layers", "Stack Separation", "Production isolated from non-production to limit blast radius"),
            ("bi-link-45deg", "URL Monitoring", "Regular checks keep endpoints reachable and behaving as expected"),
            ("bi-speedometer2", "Usage & Performance Metrics", "Track CPU, memory, disk, latency, and server health"),
            ("bi-headset", "Incident Management with SLA", "Rapid response with defined service level commitments"),
        ],
        "platform": [
            ("bi-cloud-check", "AWS Native", "Built on proven AWS services and patterns"),
            ("bi-arrow-repeat", "Automated Operations", "CI/CD and scheduled backup automation"),
            ("bi-shield-check", "Security First", "VPN, isolation, and access controls"),
            ("bi-activity", "24/7 Monitoring", "Proactive alerting and incident response"),
        ],
    },
    {
        "slug": "product-ivms",
