...
MODULES = [
    ...
    {
        "slug": "hrms-mobile-application",
        "title": "Mobile Application",
        "eyebrow": "AIVizion HRMS",
        "hero_title": "HR in Your Pocket — iOS & Android",
        "hero_text": "Give employees and managers a complete AIVizion HRMS mobile experience — self-service, geo-fenced clocking, approvals, leave, team management, and AI chat — available on both iOS and Android.",
        "description": "AIVizion HRMS Mobile Application for iOS and Android with complete self-service, geo-fenced mobile clocking, approvals, leave calendar, team management, and AI chat with report building.",
        "icon": "bi-phone",
        "image": "assets/img/hrimage/mobile-hero.png",
        "image_alt": "AIVizion HRMS mobile application home screen on iOS and Android",
        "trust_line": "iOS & Android. Self-service everywhere. Approvals on the go.",
        "solutions": [
            {
                "title": "Complete Mobile Self-Service",
                "text": "Employees handle everyday HR tasks from their phone — profiles, payslips, documents, leave applications, and request tracking — without waiting on desktop or email.",
                "bullets": [
                    "Available on both iOS and Android",
                    "Full employee self-service on mobile",
                    "Leave application and leave calendar",
                    "Payslips, documents, and profile updates",
                ],
                "image": "assets/img/hrimage/mobile-hero.png",
                "image_alt": "Mobile self-service home with leave and payslip actions",
            },
            {
                "title": "Mobile Clocking with Geo-Fencing",
                "text": "Capture attendance accurately with mobile clock-in/out protected by geo-fencing — so punches are only accepted within approved work locations.",
                "bullets": [
                    "Clock in and out from the mobile app",
                    "Geo-fence validation for work sites",
                    "Location-aware attendance records",
                    "Manager visibility of field attendance",
                ],
                "image": "assets/img/hrimage/mobile-clocking.png",
                "image_alt": "Mobile clocking screen with geo-fence map",
                "reverse": True,
            },
            {
                "title": "Approvals, Leave Calendar & AI",
                "text": "Managers approve requests anywhere, employees manage leave on a mobile calendar, and AI chat helps with questions and report building — keeping people operations moving outside the office.",
                "bullets": [
                    "All approvals available in the mobile app",
                    "Leave application and leave calendar",
                    "Team management for managers on the go",
                    "AI chat and AI-assisted report building",
                ],
                "image": "assets/img/hrimage/mobile-approvals.png",
                "image_alt": "Mobile approvals inbox and leave calendar",
            },
        ],
        "process": [
            ("Install & Sign In", "Employees download the iOS or Android app and sign in securely."),
            ("Self-Serve Daily", "Apply leave, view calendar, clock with geo-fence, and access documents."),
            ("Approve Anywhere", "Managers clear leave and other requests from the mobile inbox."),
            ("Ask & Act with AI", "Use AI chat and report building to get answers and team insights fast."),
        ],
        "capabilities": [
            ("bi-apple", "iOS app"),
            ("bi-android2", "Android app"),
            ("bi-person-badge", "Complete self-service"),
            ("bi-geo-alt", "Geo-fenced clocking"),
            ("bi-check2-square", "Mobile approvals"),
            ("bi-calendar-week", "Leave application & calendar"),
            ("bi-people", "Team management"),
            ("bi-robot", "AI chat & reports"),
        ],
        "faqs": [
            ("Is the app available on iOS and Android?", "Yes. AIVizion HRMS Mobile Application supports both iOS and Android devices."),
            ("What self-service features are included?", "Employees can manage leave, view calendars, access payslips and documents, update profile details, and track requests from the app."),
            ("How does mobile clocking with geo-fencing work?", "Employees clock in/out in the app; punches are validated against configured geo-fenced work locations for accurate attendance."),
            ("Can managers approve requests on mobile?", "Yes. Leave and other approval workflows are available in the mobile app so managers can act without returning to a desktop."),
            ("What can AI chat do in the mobile app?", "Employees and managers can ask HR-related questions and use AI-assisted report building for quick workforce insights."),
        ],
    },
]
